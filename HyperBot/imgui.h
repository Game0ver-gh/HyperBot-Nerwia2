...
struct ImColor
{
    ...
    inline ImColor& operator()(float alpha)                         { Value.w = alpha; return *this; }
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCircleProgress(const ImVec2& pos, int rad, int seg, float value, float maxValue, ImU32 color, float thickness = 1.0f, ImVec2* lastPointOut = nullptr);
