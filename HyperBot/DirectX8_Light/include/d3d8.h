...
DECLARE_INTERFACE_(IDirect3DDevice8, IUnknown)
{
    ...
    /*14*/STDMETHOD(Reset)(THIS_ D3DPRESENT_PARAMETERS * pPresentationParameters) PURE;
    /*15*/STDMETHOD(Present)(THIS_ CONST RECT * pSourceRect, CONST RECT * pDestRect, HWND hDestWindowOverride, CONST RGNDATA * pDirtyRegion) PURE;
    ...
    /*19*/STDMETHOD_(void, GetGammaRamp)(THIS_ D3DGAMMARAMP * pRamp) PURE;
    ...
    /*35*/STDMETHOD(EndScene)(THIS) PURE;
